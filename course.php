...
<marquee class="bg-dark text-white">Note: All courses held online and the whatsapp link is provided to you after enrollment of course.</marquee>
    <div class="container">
        <div class="container-fluid">
            <div class="row justify-content-between align-items-center">
                <div class="col-lg-6 col-md-6 mb-4 rm3 order-lg-1 order-3">
                    <h1 class="title">Join SuVi Courses</h1>
                    <div id="typewriter-text"></div>
                </div>
                <div class="col-md-6 col-lg-6 mt-5 order-1">
                    <img src="Images/oncourses.jpg" class="w-100 h-100">
                </div>
            </div>
            <div class="container">
                <div class="row">
                <h4 class="mb-2 mt-5 wk">Here are our Courses...</h4>
                    <?php
                    $i = 1;
                    ...
                    if (mysqli_num_rows($query_run) > 0) {
                        foreach ($query_run as $row) {
                            ...
                            $end = $row['cend'];
                    ?>
                            <div class="col-lg-3 col-md-3 my-3 p-0 m-0">
                                <div class="card border-0 shadow p-0 h-100" style="width: 300px; margin:auto;">
                                    <img src="<?php echo 'admin/course/images/' . $row['cimage']; ?>" height="250px" width="300px" alt="images">
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex justify-content-evenly mb-2">
                                            <!-- <a href="#" class="btn btn-sm text-white custom-bg shadow-none" onclick="login()">Enroll Now</a> -->
                                            <a href="crs.php?detailid=<?php echo $id;?>" class="btn btn-sm text-white custom-bg shadow-none" name="details">Enroll</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
