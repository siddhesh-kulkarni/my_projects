...
<body style="background-color:#F3F3F3;">
    ...
    if (isset($_GET['detailid'])) {
        ...
        $query = "SELECT * FROM workshop WHERE wid='$id'";
            ...
            <div class="container bg-dark text-white px-5 py-3 mt-5">
                ...
                <div class="row justify-content-between align-items-center">
                    ...
                    <div class="col-md-4 col-lg-4 mt-5 order-1">
                        <img src="<?php echo '../admin/workshop/images/' . $row['wimage']; ?>" height="350px" width="400px" class="shadow" alt="images">
                    </div>
                </div>
                <button class="learnworlds-button learnworlds-button-solid-brand learnworlds-button-normal learnworlds-element cursor-pointer mb-2">
                    <a href="wkenroll.php?wkid=<?php echo $id; ?>" class="text-decoration-none text-white">Pay Here</a>
                </button>
                ...
                <a href="studwshop.php" class="text-decoration-none text-white">Cancel</a> 
                </button>
            </div>
    <?php
        }
