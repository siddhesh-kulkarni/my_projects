                ...
                <h4 class="mb-2 mt-5 wk">Here are our Courses...</h4>
                    ...
                    ?>
                            <div class="col-lg-3 col-md-3 my-3">
                                <div class="card border-0 p-0 shadow h-100" style="width: 300px; margin:auto;">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex justify-content-evenly mb-2">
                                            ...
                                            <a href="studcrs.php?detailid=<?php echo $id;?>" class="btn btn-sm text-white custom-bg shadow-none" name="details">Enroll</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
