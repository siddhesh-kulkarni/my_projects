...
if(isset($_POST['submit'])){
        ...
        $query1="INSERT INTO `crsenroll`(`cid`, `cname`, `sid`, `sfname`, `smobile`, `transaction_id`, `payment`) VALUES ('$cid','$cname','$id','$name','$mob','$trid','Pending')";
                ...
                <div class="col-lg-6 col-md-6 mb-4 rm3 order-lg-1 order-3">
                    <form method="POST">
                        ...
                        <button class="learnworlds-button-normal cursor-pointer mb-2 mx-2">
                            <a href="../student/studcourse.php" class="text-decoration-none text-white">Cancel</a>
                        </button>
                    </form>
                </div>
