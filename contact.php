          ...
          <div class="bg-white rounded shadow p-4">
            <form method="POST">
              ...
              <div class="mb-3">
                ...
                <input type="text" maxlength="10" name="qmob" required pattern="[7-9][0-9]{9}" class="form-control shadow-none" required>
              </div>
              <div class="mb-3">
                ...
                <button type="submit" name="send" class="btn custom-bg shadow-none text-white" onclick="login()">SEND</button>
            </form>
          </div>
        </div>
      </div>
