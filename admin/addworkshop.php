                        ...
                        <div class="card-body">
                            <form method="POST" enctype="multipart/form-data">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" placeholder="Enter Workshop Name" autocomplete="off" name="wname" required>
                                </div>
                                <div class="mb-3">
                                    <label>Workshop Details</label>
                                    <input type="text" class="form-control" placeholder="Enter Workshop Details" autocomplete="off" name="wdetails" required>
                                </div>
                                <div class="mb-3">
                                    <label>Workshop Fees</label>
                                    <input type="text" class="form-control" placeholder="Enter Workshop Fees" autocomplete="off" name="wfees" required>
                                </div>
                                <div class="mb-3">
                                    <label>Start Date</label>
                                    <input type="date" class="form-control" autocomplete="off" name="wstart" required>
                                </div>
                                <div class="mb-3">
                                    <label>End Date</label>
                                    <input type="date" class="form-control" autocomplete="off" name="wend" required>
                                </div>
                                <div class="mb-3">
                                    <label>Workshop Image</label>
                                    <input type="file" class="form-control" autocomplete="off" name="wimage" required>
                                </div>
