                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        if (mysqli_num_rows($query_run) > 0) {
                                            ...
                                            <td>' . $smobile . '</td>
                                            <td>' . $trid . '</td>
                                            <td><button class="btn btn-success" name="submit"><a href="crsenroll.php?pid=' . $pid . '" class="text-white">' . $pay . '</a></button></td>
                                </tr>';
                                            }
                                        } else {
                                            echo "no records";
                                        ...
                                        if (isset($_GET['pid'])) {
                                            $pid = $_GET['pid'];
                                            $query = "UPDATE crsenroll SET payment='Paid' WHERE pid=$pid";
                                            $query_run = mysqli_query($con, $query);
                                            ...
                                            if($query_run){
                                                echo <<<JS
                                                    ...
                                                    if (result.isConfirmed) {
                                                        ...
                                                        window.location.href = 'crsenroll.php'; // Redirect to desired page after updating payment status
                                                        });
                                                    } else if (
