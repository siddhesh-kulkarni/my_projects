        ...
        <div class="main">
            ...
            <main class="content px-3 py-2">
                <div class="container-fluid">
                    <button class="btn btn-primary mt-2 ms-5 mb-3"><a href="addcourse.php" class="text-light text-decoration-none"><i class="bi bi-plus-circle me-2"></i>Add Course</a></button>
                    <div class="card ms-5 col-lg-10 col-md-10">
                        <div class="card-body" style="overflow-y: auto; max-height: 500px;">
                            <table class="table  tb">
                                <thead>
                                    <tr>
                                        <th scope="col" class="tb1">Sr No</th>
                                        <th scope="col" class="tb2">Course Name</th>
                                        <th scope="col" class="tb3">Course Details</th>
                                        <th scope="col" class="tb4">Course Fees</th>
                                        <th scope="col" class="tb5">Start Date</th>
                                        <th scope="col" class="tb6">End Date</th>
                                        <th scope="col" class="tb7">Image</th>
                                        <th scope="col" class="tb8">Update</th>
                                        <th scope="col" class="tb9">Delete</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php
                                    ...
                                    if (mysqli_num_rows($query_run) > 0) {
                                        foreach ($query_run as $row) {
                                            ...
                                            <tr>
                                            <td class="tb1">' . $i++ . '</td>
                                            <td class="tb2">' . $name . '</td>
                                            <td class="tb3">' . $detail . '</td>
                                            <td class="tb4">' . $fees . '</td>
                                            <td class="tb5">' . $start . '</td>
                                            <td class="tb6">' . $end . '</td>
                                            ';
                                    ?>
                                            <td>
                                                <img src="<?php echo 'course/images/' . $row['cimage']; ?>" height="80px" width="100px" alt="images" class="tb7">
                                            </td>
                                    <?php
                                            echo '
                                            <td>
                                                <button class="btn btn-primary tb8"><a class="text-white" href="cupdate.php?updateid=' . $id . '"><i class="bi bi-pencil-square"></i></a></button>
                                            
                                            <td>
                                                <button class="btn btn-danger tb9"><a class="text-white" href="cdelete.php?deleteid=' . $id . '"><i class="bi bi-trash3-fill"></i></a></button>
                                            </td>
                                            </tr>';
                                        }
                                    } else {
