        ...
        <div class="main">
            ...
            <main class="content px-3 py-2">
                <div class="container-fluid">
                    <h3 class="ms-5">Enrolled Students</h3>
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        if (mysqli_num_rows($query_run) > 0) {
                                            ...
                                            <td>' . $smobile . '</td>
                                            <td>' . $trid . '</td>
                                            <td><button class="btn btn-success" name="submit"><a href="wkenroll.php?pid=' . $pid . '" class="text-white">' . $pay . '</a></button></td>
                                </tr>';
                                            }
                                        } else {
                                            echo "no records";
                                        ...
                                        if (isset($_GET['pid'])) {
                                            $pid = $_GET['pid'];
                                            $query = "UPDATE wkenroll SET payment='Paid' WHERE pid=$pid";
                                            $query_run = mysqli_query($con, $query);
                                        //     if ($query_run) {
                                        //     //     echo <<<JS
                                        ...
                                        // }
                                    //     if ($query_run) {
                                    //         // Payment status updated successfully, show SweetAlert
                                    //         echo '
                                    ...
                                    //             icon: "success"
                                    //         }).then(() => {
                                    //             window.location.href = "wkenroll.php";
                                    //         });
                                    //         </script>';
                                    // } else {
                                    //     // Payment status update failed, show SweetAlert
                                    //     echo '
                                    //     <script src="https://cdn.jsdelivr.net/npm/sweetalert2@11"></script>
                                    //         <script>
                                    //         const swalWithBootstrapButtons = Swal.mixin({
                                    ...
                                    if($query_run){
                                        echo <<<JS
                                            ...
                                            confirmButtonText: "Yes, update payment status",
                                            ...
                                            if (result.isConfirmed) {
                                                ...
                                                window.location.href = 'wkenroll.php'; // Redirect to desired page after updating payment status
                                                });
                                            } else if (
                                                ...
                                                swalWithBootstrapButtons2.fire({
                                                title: "Cancelled",
                                                text: "Payment status remains unchanged.",
                                                icon: "error"
                                                });
                                            }
                                            });
