        ...
        <div class="main">
            ...
            <main class="content px-3 py-2">
                <div class="container-fluid">
                    <button class="btn btn-primary mt-2 ms-5 mb-3"><a href="addworkshop.php" class="text-light text-decoration-none"><i class="bi bi-plus-circle me-2"></i>Add Workshop</a></button>
                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                                <td>
                                                    <img src="<?php echo 'workshop/images/' . $row['wimage']; ?>" height="80px" width="100px" alt="images">
                                                </td>
                                        <?php
                                                echo '
                                    <td>
                                    <button class="btn btn-primary"><a class="text-white" href="wupdate.php?updateid=' . $id . '"><i class="bi bi-pencil-square"></i></a></button>
                                    </td>
                                    <td>
                                    <button class="btn btn-danger"><a class="text-white" href="wdelete.php?deleteid=' . $id . '"><i class="bi bi-trash3-fill"></i></a></button>
                                    </td>
                                </tr>';
                                            }
                                        } else {
