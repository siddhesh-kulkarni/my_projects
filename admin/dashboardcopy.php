...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="/admin/">
                            ...
                            <div class="card text-center">
                                <div class="card-header">
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" class="bi bi-motherboard-fill" viewBox="0 0 16 16">
                                                <path d="M5 7h3V4H5z" />
                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        $q1 = "SELECT sfname, smobile, cname, payment FROM crsenroll";
                                        ...
                                        if (mysqli_num_rows($query_run) > 0) {
                                            foreach ($query_run as $row) {
                                                ...
                                                <td>' . $smobile . '</td>
                                                <td>' . $cname . '</td>
                                                <td><button class="btn btn-success" name="submit">' . $p1 . '</button></td>
                                                </tr>
                                                    ';
                                            }
                                        } else {
                                ...
                                <table class="table">
                                    <thead>
                                        <tr>
                                            ...
                                            <th scope="col">Workshop Payment</th>
                                    ...
                                    <tbody>
                                        <?php
                                        $i = 1;
                                        $q1 = "SELECT sfname, smobile, wname, payment FROM wkenroll";
